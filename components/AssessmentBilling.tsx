  ...
  const filteredHistory = useMemo(() => {
    ...
    return applied.filter((rec) => {
      ...
      const matchesSearch =
        ...
        String(rec.rNo || "").toLowerCase().includes(filterSearch.toLowerCase()) ||
        ...
        >
          ...
          <div className="flex gap-3 items-center flex-wrap">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search name / AIN / phone / challan..."
            ...
            <button
              onClick={() => printElement(document.getElementById("assessment-table"), "Assessment Billing Records", {
                header: {
